...
void renderManager::renderRain(game& g) {
	renderMonocolorLineBatch(g.getEffectsManager().getRainManager().getPrimaryBatch());
	renderMonocolorLineBatch(g.getEffectsManager().getRainManager().getSecondaryBatch());
};
