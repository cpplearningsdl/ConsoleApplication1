...
public:
    static lightningStrike generate(SDL_FPoint start, SDL_FPoint end, const lightningGeneratorConfig& cfg, uint32_t seed, std::optional<SDL_FPoint> target = std::nullopt);
